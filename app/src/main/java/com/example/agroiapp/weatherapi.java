...
public class weatherapi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CITY= Objects.requireNonNull(getIntent().getExtras()).getString("value10");
    }
        ...
        protected void onPreExecute() {
            ...
            findViewById(R.id.pincdweth).setVisibility(View.GONE);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                findViewById(R.id.pincdweth).setVisibility(View.VISIBLE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.item1:
                startActivity(new Intent(weatherapi.this, agrihome.class));
                return true;
            default:
